    ...
    if call == 0:
        ...
        while(inProgress == 1):
            ...
            if timePassed >= waitTime:
                waitTime = 1
                #inProgress = 0
                #print("Looks like your time is up! >:(")
                reset = 1
                #break
            ...
            if (reset == 0):
                ...
                try:
                    ...
                    break
                #print("Received: ", rdt_rcv(rcvpkt))
                #print("Corrupt: ", corrupt(rcvpkt, checksum))
                #print("is ACK 1:", isACK(rcvpkt, b'1'))
                if rdt_rcv(rcvpkt) is True and (corrupt(rcvpkt, checksum) is False and isACK(rcvpkt, b'1') is False):
                    inProgress = 0
                    #print("Packet Received")

                elif rdt_rcv(rcvpkt) is True and (corrupt(rcvpkt, checksum) is True):
                    #waitTime = 0
                    reset = 1
            '''
